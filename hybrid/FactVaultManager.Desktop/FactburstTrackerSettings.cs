...
public static class FactburstTrackerSettingsStore
{
    ...
    {
        var rootUrl = FactburstLinkTrackerClient.NormalizeBaseUrl(baseUrl);
        var key = (apiKey ?? "").Trim();
        if (key.Length < 16)
