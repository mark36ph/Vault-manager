...
public static class QuizVisualThemeCatalog
{
    ...
    [
        new(
            "dark",
            "Dark",
            Color.FromRgb(31, 27, 34),
            Color.FromRgb(255, 252, 247),
            Color.FromRgb(44, 211, 255),
            Color.FromRgb(255, 196, 61),
            Color.FromRgb(55, 47, 62),
            Color.FromRgb(119, 97, 132),
            Color.FromRgb(255, 250, 244),
            Color.FromRgb(209, 196, 216),
            Color.FromRgb(21, 104, 79),
            Color.FromRgb(74, 222, 128),
            Color.FromRgb(255, 208, 72),
            Color.FromRgb(215, 112, 255)),
        new(
            "clean",
            "Clean",
