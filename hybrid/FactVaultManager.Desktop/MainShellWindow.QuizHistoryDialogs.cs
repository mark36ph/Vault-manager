...
public partial class MainShellWindow
{
    ...
    private void ShowSelectedQuizHistoryQuestionsRestored()
    {
        ...
        grid.Columns.Add(new DataGridTextColumn { Header = "Answer", Binding = new Binding(nameof(QuizHistoryQuestion.Answer)), ElementStyle = questionTextStyle, Width = new DataGridLength(220) });
        Grid.SetRow(grid, 1);
