...
public sealed class AutopilotMasterSwitchTests
{
    ...
    public void Build79_UsesOneVisibleMasterAutopilotSwitch()
    {
        ...
        // Schedule supervision is intentionally opt-in now; startup must not initialize it.
        Assert.DoesNotContain("InitializeAutopilotScheduleTarget()", buildInfo, StringComparison.Ordinal);
