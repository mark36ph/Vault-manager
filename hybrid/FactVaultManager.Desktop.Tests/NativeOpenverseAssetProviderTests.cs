...
{
    [Fact]
    public async Task Search_UsesConciseFecesVocabularyAndPublicDomainFilter()
    {
        ...
        Assert.Contains("wombat + (droppings | feces | faeces | poop | scat)", decodedQuery, StringComparison.OrdinalIgnoreCase);
        Assert.DoesNotContain("ground", decodedQuery, StringComparison.OrdinalIgnoreCase);
        Assert.DoesNotContain("wildlife", decodedQuery, StringComparison.OrdinalIgnoreCase);
        Assert.DoesNotContain("Australia", decodedQuery, StringComparison.OrdinalIgnoreCase);
    }
    ...
    {
        Assert.Equal(
            "wombat + (droppings | feces | faeces | poop | scat)",
            NativeOpenverseAssetProvider.BuildSearchQuery(
                "documentary wombat droppings rock ground Australia"));
    }
