...
public sealed class RetiredFactCreationCleanupTests
{
    ...
    [Fact]
    public void Build152_IsCurrentBuildAndVersionManifestMatches()
    {
        ...
        Assert.Contains("CurrentBuildNumber = 152", buildInfo, StringComparison.Ordinal);
        Assert.Contains("\"latest_version\": \"1.0.126\"", version, StringComparison.Ordinal);
        Assert.Contains("\"build\": 152", version, StringComparison.Ordinal);
    }
