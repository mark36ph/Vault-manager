...
public sealed class RetiredFactCreationCleanupTests
{
    ...
    [Fact]
    public void Build162_IsCurrentBuildAndVersionManifestMatches()
    {
        ...
        Assert.Contains("CurrentBuildNumber = 162", buildInfo, StringComparison.Ordinal);
        Assert.Contains("\"latest_version\": \"1.0.141\"", version, StringComparison.Ordinal);
        Assert.Contains("\"build\": 162", version, StringComparison.Ordinal);
    }
